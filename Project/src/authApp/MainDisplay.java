...
public class MainDisplay {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(MainDisplay.class.getResource("/authApp/img/user25.png")));
		lblNewLabel.setBounds(92, 90, 25, 27);
		frmYuconzSystem.getContentPane().add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(MainDisplay.class.getResource("/authApp/img/lock25.png")));
